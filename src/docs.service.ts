...
Perform a skill gap analysis in the following json format.
{
  ...
  "summary": "a summary of the skill gap analysis"
}
return only the json and nothing else. i have a program that expect the json output so returning extra texts around the json will create unwanted behaviors in my program
  `;
  }
